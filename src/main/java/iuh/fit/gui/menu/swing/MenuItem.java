package iuh.fit.gui.menu.swing;

import iuh.fit.gui.menu.event.EventMenu;
import iuh.fit.gui.menu.event.EventMenuSelected;
import iuh.fit.gui.menu.model.ModelMenu;
...
public class MenuItem extends javax.swing.JPanel {
    ...
    public MenuItem(ModelMenu menu, EventMenu event, EventMenuSelected eventSelected, int index) {
        ...
        firstItem.setFont(getFont().deriveFont(20f));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setColor(new Color(225, 240, 255)); // xanh nhạt dịu, hợp màu sidebar
